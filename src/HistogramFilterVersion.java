...
public class HistogramFilterVersion {
	...
	public ChartPanel createChartPanel(String feature, double[] values, int BINS, IntervalMarker intervalMarker) {
		...
		// chart
		JFreeChart chart = ChartFactory.createHistogram("", feature, "", dataset, PlotOrientation.VERTICAL, true, true,
				false);

		plot = (XYPlot) chart.getPlot();
		renderer = (XYBarRenderer) plot.getRenderer();
		renderer.setBarPainter(new StandardXYBarPainter());
		// translucent red, green & blu
		...
		panel.setPreferredSize(new Dimension(390, 180));
	...
	public void addHistogramSeries(String feature, double[] values, int BINS, IntervalMarker intervalMarker) {
		...
		// chart
		JFreeChart chart = ChartFactory.createHistogram("", feature, "COUNTING", dataset, PlotOrientation.VERTICAL,
				true, true, false);
