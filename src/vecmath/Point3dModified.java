 ...
 *
 */
public class Point3dModified extends Tuple3dModified implements java.io.Serializable {

    // Compatible with 1.1
    static final long serialVersionUID = 5718062286069042927L;

    /**
     * Constructs and initializes a Point3dModified from the specified xyz coordinates.
    ...
    /**
     * Constructs and initializes a Point3dModified from the array of length 3.
    ...
    /**
     * Constructs and initializes a Point3dModified from the specified Point3dModified.
     * @param p1 the Point3dModified containing the initialization x y z data
     */
    ...
    /**
     * Constructs and initializes a Point3dModified from the specified Point3f.
    ...
    /**
     * Constructs and initializes a Point3dModified from the specified Tuple3f.
    ...
    /**
     * Constructs and initializes a Point3dModified from the specified Tuple3d.
    ...
    /**
     * Constructs and initializes a Point3dModified to (0,0,0).
     */
