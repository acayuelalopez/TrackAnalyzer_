...
public class FirstWizardPanel extends LabelWizardPanel {
	...
	public FirstWizardPanel(JWizardComponents wizardComponents) {
		...
		File imageFolder = new File(SPTAnalyzer_.textImages.getText());
		...
		for (int u = 0; u < filesXML.length; u++)
			filesXML[u] = new File(SPTAnalyzer_.textXml.getText());
		...
		for (int i = 0; i < listOfFiles.length; i++) {
			...
			imps[i] = IJ.openImage(SPTAnalyzer_.textImages.getText() + "/" + imageTitles[i]);
