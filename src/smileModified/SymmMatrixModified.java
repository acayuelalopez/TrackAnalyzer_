...
public class SymmMatrixModified extends IMatrixModified {
    ...
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(SymmMatrixModified.class);
    ...
    public SymmMatrixModified clone() {
        SymmMatrixModified matrix = new SymmMatrixModified(uplo, n);
    ...
    public boolean equals(Object o) {
        if (!(o instanceof SymmMatrixModified)) {
            return false;
        }

        return equals((SymmMatrixModified) o, 1E-10);
    }
    ...
    public void mv(TransposeModified trans, double alpha, double[] x, double beta, double[] y) {
        BLASModified.engine.spmv(layout(), uplo, n, alpha, AP, x, 1, beta, y, 1);
    }
    ...
    public void mv(double[] work, int inputOffset, int outputOffset) {
        ...
        BLASModified.engine.spmv(layout(), uplo, n, 1.0, DoubleBuffer.wrap(AP), xb, 1, 0.0, yb, 1);
    }
    ...
    public static class BunchKaufman implements Serializable {
        ...
        public void solve(MatrixModified B) {
            ...
            int ret = LAPACKModified.engine.sptrs(lu.layout(), lu.uplo, lu.n, B.n, lu.AP, ipiv, B.A, B.ld);
            if (ret != 0) {
    ...
    public static class Cholesky implements Serializable {
        ...
        public void solve(MatrixModified B) {
            ...
            int info = LAPACKModified.engine.pptrs(lu.layout(), lu.uplo, lu.n, B.n, lu.AP, B.A, B.ld);
            if (info != 0) {
