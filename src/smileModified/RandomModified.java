...
public class RandomModified {
    ...
    public RandomModified() {
        real = new UniversalGeneratorModified();
        twister = new MersenneTwisterModified();
    }
    ...
    public RandomModified(long seed) {
        real = new UniversalGeneratorModified(seed);
        twister = new MersenneTwisterModified(seed);
    }
