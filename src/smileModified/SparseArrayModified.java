...
public class SparseArrayModified implements Iterable<SparseArrayModified.Entry>, Serializable {
    ...
    public class Entry {
        ...
        public String toString() {
            return String.format("%d:%s", i, StringsModified.format(x));
        }
    }
    ...
    public SparseArrayModified(int initialCapacity) {
        index = new IntArrayListModified(initialCapacity);
        value = new DoubleArrayListModified(initialCapacity);
    }
    ...
    public SparseArrayModified(List<Entry> entries) {
        index = new IntArrayListModified(entries.size());
        value = new DoubleArrayListModified(entries.size());
     ...
     */
    public void sort() {
        QuickSortModified.sort(index.data, value.data, size());
    }
