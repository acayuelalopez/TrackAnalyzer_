		...
		if (SPTBatch_.checkboxSubBg.isSelected() == true) {
			...
			if (SPTBatch_.checkTracks.isSelected() == true)
				columnNamesTracks = new String[] { "LABEL", "TRACK_INDEX", "TRACK_ID", "NUMBER_SPOTS", "NUMBER_GAPS",
						...
						"LINEARITY_OF_FORWARD_PROGRESSION", "MEAN_DIRECTIONAL_CHANGE_RATE", "MSD Coef.",
						"Intensity-Bg Subtract",
						"Intensity-Bg Subtract" + " (" + SPTBatch_.minTracks.getText() + "-"
								+ SPTBatch_.maxTracks.getText() + ")",
			...
			if (SPTBatch_.checkTracks.isSelected() == false)
				columnNamesTracks = new String[] { "LABEL", "TRACK_INDEX", "TRACK_ID", "NUMBER_SPOTS", "NUMBER_GAPS",
						...
						"MAX_DISTANCE_TRAVELED", "CONFINMENT_RATIO", "MEAN_STRAIGHT_LINE_SPEED",
						"LINEARITY_OF_FORWARD_PROGRESSION", "MEAN_DIRECTIONAL_CHANGE_RATE", "MSD Coef.",
						"Intensity-Bg Subtract", "D1-4 Coef.", "Track Length", "Motility", "Alpha", "Movement" };
		}
		if (SPTBatch_.checkboxSubBg.isSelected() == false) {
			columnNamesTracks = new String[] { "LABEL", "TRACK_INDEX", "TRACK_ID", "NUMBER_SPOTS", "NUMBER_GAPS",
					...
					"MSD Coef.", "D1-4 Coef.", "Track Length", "Motility", "Alpha", "Movement" };
		}
...
//		columnParmText = new JTextField("5", 5);
		// combo.setSelectedIndex(SPTBatch_.pref1.getInt("",
		// SPTBatch_.TRACKMATE_SLT_PARAM));
